        ...
        <div class="container-fluid">
            <div class="form-head d-flex mb-0 mb-lg-4 align-items-start">
                <div class="mr-auto d-none d-lg-block">
                    <h2 class="text-black font-w600">Permissions ...</h2>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu text-center">
                                                    <a class="dropdown-item" href="{{route('editpermission',['permission'=>$permission['id']])}}">Edit</a>
                                                    <form method="post" class="dropdown-item" action="{{route('deletepermission',['permission'=>$permission])}}">
                                                        @method('DELETE')
                                                        @csrf
