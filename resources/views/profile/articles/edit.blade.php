                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        ...
                                        @endif
                                        <form method="post" action="{{route('edit.article',['article'=>$article])}}" enctype="multipart/form-data">

                                            @csrf
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label>Title</label>
                                                    <input name="title" value="{{$article['title']}}" type="text" class="form-control" placeholder="Name ...">
                                                </div>
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <textarea class="form-control" id="description" name="description" rows="4" placeholder="Enter your description here ...">
                                                        {{$article['description']}}
                                                    </textarea>
                                                </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <input  value="{{$article['image']}}" type="text" class="form-control" disabled>
